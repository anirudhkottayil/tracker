...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--today", action="store_true", help="To show today's sessions")
    parser.add_argument("--yesterday", action="store_true", help="To show yesterday's sessions")
    parser.add_argument("--week", action="store_true", help="To show the sessions for this week (From Monday)")
    parser.add_argument("--lweek", action="store_true", help="To show the sessions for last week (From previous Monday)")
    parser.add_argument("--month", action="store_true", help="To show the sessions for the current month")
    parser.add_argument("--lmonth", action="store_true", help="To show the sessions for last month")
    parser.add_argument("--year", action="store_true", help="To show the sessions for the year")
